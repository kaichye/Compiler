...
public class Operand {
     ...
     * INTEGER is for integer literals                                       - numExpression
     *    DATA FIELD - uses a Integer value
     ...
     *    - uses a String value, which is name of register                   - like RetReg
...
//      throw new parser.CodeGenerationException("Operand: invalid type");
        throw new parser.CMinusParserException("Operand: invalid type");
    }
  }
